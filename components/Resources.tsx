  ...
  return (
    <>
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-3">
        ...
        <Link
          href="#contact"
          className="rounded-md border border-zinc-900 px-6 py-3 text-sm font-medium text-zinc-900 hover:bg-zinc-100 transition-colors text-center flex items-center"
        >
          ☕️ Contact me for a free lesson
        </Link>
      </div>
    </>
  );
